...
function LoginScreen() {
  ...
  const { phoneNumber, setPhoneNumber, countryCode } = useLoginAndRegistrationStore();
      ...
      <View className="m-auto  flex-1 pt-[50]" style={{ width: dynamicWidth }}>
        ...
        <View className="items-center justify-center">
          ...
          <TouchableOpacity onPress={() => navigation.navigate('loginWithEmailOrUsername')}>
            <Text className=" pt-[25] text-gray-500 underline">Use email or username instead</Text>
          </TouchableOpacity>
        </View>
        <Text
          style={{ paddingTop: height * 0.06, paddingBottom: height * 0.05 }}
          className="mx-auto  font-[600] text-[15] text-black">
          OR
        </Text>
        ...
        <View className="flex-row items-center justify-center pt-[30]">
          ...
          <TouchableOpacity onPress={() => navigation.navigate('phoneNumberLoginAndRegistration')}>
